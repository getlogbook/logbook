...
`1.10.1 <https://github.com/getlogbook/logbook/releases/tag/1.10.1>`_ - 2026-08-05
----------------------------------------------------------------------------------
...
`1.10.0 <https://github.com/getlogbook/logbook/releases/tag/1.10.0>`_ - 2026-08-05
----------------------------------------------------------------------------------
...
- Logging performance has improved significantly: resolving the active
  ...
  multi-threaded logging no longer takes a shared lock. This especially
  benefits free-threaded Python.
  `#607 <https://github.com/getlogbook/logbook/pull/607>`_
- ``manylinux2014`` wheels are provided once again on ``x86_64``, restoring
  support for distributions with glibc 2.17 or newer.
- ``universal2`` macOS wheels are no longer built. Separate ``x86_64`` and
  ``arm64`` wheels continue to be provided.

Deprecated
~~~~~~~~~~

- :func:`logbook.notifiers.create_notification_handler`
- :class:`logbook.notifiers.LibNotifyHandler`
- Support for ``x86_64`` macOS. Logbook 2.0 will only publish ``arm64`` wheels
  for macOS.

Fixed
~~~~~

- The queue subscribers no longer emit spurious deprecation warnings
  from their background dispatch threads.
- Calling the deprecated ``pop_thread`` or ``pop_greenlet`` on
  :class:`~logbook.GroupHandler` and :class:`~logbook.more.DedupHandler`
  now attributes the ``DeprecationWarning`` to the calling code instead of
  logbook internals.

`1.9.2 <https://github.com/getlogbook/logbook/releases/tag/1.9.2>`_ - 2025-11-27
--------------------------------------------------------------------------------
...
`1.9.1 <https://github.com/getlogbook/logbook/releases/tag/1.9.1>`_ - 2025-11-06
--------------------------------------------------------------------------------
...
`1.9.0 <https://github.com/getlogbook/logbook/releases/tag/1.9.0>`_ - 2025-11-05
--------------------------------------------------------------------------------
...
`1.8.2 <https://github.com/getlogbook/logbook/releases/tag/1.8.2>`_ - 2025-06-14
--------------------------------------------------------------------------------
...
`1.8.1 <https://github.com/getlogbook/logbook/releases/tag/1.8.1>`_ - 2025-03-19
--------------------------------------------------------------------------------

- Fixed crash on Python 3.12+ in speedups extension module.

`1.8.0 <https://github.com/getlogbook/logbook/releases/tag/1.8.0>`_ - 2024-10-26
--------------------------------------------------------------------------------
...
`1.7.0.post0 <https://github.com/getlogbook/logbook/releases/tag/1.7.0.post0>`_ - 2023-11-11
--------------------------------------------------------------------------------------------
...
`1.7.0 <https://github.com/getlogbook/logbook/releases/tag/1.7.0>`_ - 2023-10-03
--------------------------------------------------------------------------------
...
`1.6.0 <https://github.com/getlogbook/logbook/releases/tag/1.6.0>`_ - 2023-07-30
--------------------------------------------------------------------------------
...
`1.5.3 <https://github.com/getlogbook/logbook/releases/tag/1.5.3>`_ - 2019-10-16
--------------------------------------------------------------------------------
...
`1.5.2 <https://github.com/getlogbook/logbook/releases/tag/1.5.2>`_ - 2019-08-21
--------------------------------------------------------------------------------
...
`1.5.1 <https://github.com/getlogbook/logbook/releases/tag/1.5.1>`_ - 2019-08-21
--------------------------------------------------------------------------------
...
`1.4.3 <https://github.com/getlogbook/logbook/releases/tag/1.4.3>`_ - 2019-01-16
--------------------------------------------------------------------------------
...
`1.4.2 <https://github.com/getlogbook/logbook/releases/tag/1.4.2>`_ - 2018-12-11
--------------------------------------------------------------------------------
...
`1.4.1 <https://github.com/getlogbook/logbook/releases/tag/1.4.1>`_ - 2018-10-14
--------------------------------------------------------------------------------
...
`1.4.0 <https://github.com/getlogbook/logbook/releases/tag/1.4.0>`_ - 2018-05-15
--------------------------------------------------------------------------------
...
`1.3.0 <https://github.com/getlogbook/logbook/releases/tag/1.3.0>`_ - 2018-03-05
--------------------------------------------------------------------------------
...
`1.2.0 <https://github.com/getlogbook/logbook/releases/tag/1.2.0>`_ - 2018-02-08
--------------------------------------------------------------------------------
...
`1.1.0 <https://github.com/getlogbook/logbook/releases/tag/1.1.0>`_ - 2017-07-13
--------------------------------------------------------------------------------
...
`1.0.0 <https://github.com/getlogbook/logbook/releases/tag/1.0.0>`_ - 2016-06-26
--------------------------------------------------------------------------------
...
`0.12.0 <https://github.com/getlogbook/logbook/releases/tag/0.12.0>`_ - 2015-11-24
----------------------------------------------------------------------------------
...
`0.11.3 <https://github.com/getlogbook/logbook/releases/tag/0.11.3>`_ - 2015-11-05
----------------------------------------------------------------------------------
...
`0.11.2 <https://github.com/getlogbook/logbook/releases/tag/0.11.2>`_ - 2015-09-29
----------------------------------------------------------------------------------
...
`0.11.0 <https://github.com/getlogbook/logbook/releases/tag/0.11.0>`_ - 2015-09-29
----------------------------------------------------------------------------------
...
`0.10.1 <https://github.com/getlogbook/logbook/releases/tag/0.10.1>`_ - 2015-08-04
----------------------------------------------------------------------------------
...
`0.10.0 <https://github.com/getlogbook/logbook/releases/tag/0.10.0>`_ - 2015-07-14
----------------------------------------------------------------------------------
...
`0.9.1 <https://github.com/getlogbook/logbook/releases/tag/0.9.1>`_ - 2015-05-04
--------------------------------------------------------------------------------
...
`0.9.0 <https://github.com/getlogbook/logbook/releases/tag/0.9.0>`_ - 2015-02-12
--------------------------------------------------------------------------------
...
`0.8.1 <https://github.com/getlogbook/logbook/releases/tag/0.8.1>`_ - 2014-11-30
--------------------------------------------------------------------------------
...
`0.8.0 <https://github.com/getlogbook/logbook/releases/tag/0.8.0>`_ - 2014-11-11
--------------------------------------------------------------------------------
...
`0.7.0 <https://github.com/getlogbook/logbook/releases/tag/0.7.0>`_ - 2014-05-12
--------------------------------------------------------------------------------
...
`0.6.0 <https://github.com/getlogbook/logbook/releases/tag/0.6.0>`_ - 2013-10-03
--------------------------------------------------------------------------------
...
`0.5.0 <https://github.com/getlogbook/logbook/releases/tag/0.5.0>`_ - 2013-08-10
--------------------------------------------------------------------------------
...
`0.4.2 <https://github.com/getlogbook/logbook/releases/tag/0.4.2>`_ - 2013-06-02
--------------------------------------------------------------------------------
...
`0.4.1 <https://github.com/getlogbook/logbook/releases/tag/0.4.1>`_ - 2012-12-12
--------------------------------------------------------------------------------
...
`0.2.1 <https://github.com/getlogbook/logbook/releases/tag/0.2.1>`_ - 2010-09-21
--------------------------------------------------------------------------------
...
`0.2 <https://github.com/getlogbook/logbook/releases/tag/0.2>`_ - 2010-09-21
----------------------------------------------------------------------------
...
`0.1 <https://github.com/getlogbook/logbook/releases/tag/0.1>`_ - 2010-07-25
----------------------------------------------------------------------------
