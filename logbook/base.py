...
class LoggerMixin(object):
    """
    This mixin defines and implements the logger interface.

    Subclasses have to implement a :meth:`handle` method which takes a
    :class:`LogRecord` and passes it along.
    """
