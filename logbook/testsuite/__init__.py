...
def suite():
    ...
    suite.addTest(unittest.makeSuite(BasicAPITestCase))
    suite.addTest(unittest.makeSuite(HandlerTestCase))
    suite.addTest(unittest.makeSuite(AttributeTestCase))
    suite.addTest(unittest.makeSuite(FlagsTestCase))
    suite.addTest(unittest.makeSuite(LoggerGroupTestCase))
    suite.addTest(unittest.makeSuite(DefaultConfigurationTestCase))
    suite.addTest(unittest.makeSuite(LoggingCompatTestCase))
    suite.addTest(unittest.makeSuite(WarningsCompatTestCase))
    suite.addTest(unittest.makeSuite(MoreTestCase))
    suite.addTest(unittest.makeSuite(QueuesTestCase))
    suite.addTest(unittest.makeSuite(TicketingTestCase))
