...
"""Test harness for the logbook module. Run all tests.
...
class SocketHandlerTest(BaseTest):
    ...
    def setUp(self):
        ...
        self.sock_hdlr.formatter = self.root_formatter
...
class WarningsTest(object):#BaseTest):
